      ...
      <div className="p-6 space-y-8">
        ...
        <section className="space-y-4">
          ...
          <Input 
            ...
            className="rounded-xl border-border bg-muted font-bold text-foreground" 
          />
        </section>

        <section className="space-y-4">
          <h2 className="text-[12px] font-bold text-muted-foreground uppercase px-1">세탁 품목 및 수량</h2>
          {items.map((item) => (
              ...
              <CardContent className="p-6 space-y-6">
                <div className="flex justify-between items-center">
                  <div className="space-y-1">
                    ...
                    <p className="text-[10px] text-muted-foreground font-medium">단위: {item.unit}</p>
                  </div>
        ...
        <section className="space-y-4 pb-12">
          ...
          <Textarea 
            ...
            className="rounded-2xl border-border bg-white p-5 font-medium text-sm min-h-[120px]"
            value={notes}

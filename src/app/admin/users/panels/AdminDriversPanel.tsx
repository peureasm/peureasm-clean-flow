...
// NOTE: 기존 `/admin/drivers` 페이지 로직을 `사용자/권한 관리` 탭으로 흡수하기 위한 패널입니다.
...
import { Search, Plus, Truck, User, Mail, Loader2, Hospital, ChevronRight, Share2, MoreVertical, Pencil, Trash2 } from 'lucide-react';
    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-muted-foreground font-medium text-sm">기사 프로필과 배정 현황을 관리하고 공용 초대 링크를 제공합니다.</p>
        </div>
